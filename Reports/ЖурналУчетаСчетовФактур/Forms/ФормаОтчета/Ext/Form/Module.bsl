...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	УчетНДСКлиентПереопределяемый.ПриЗакрытии(ЭтаФорма, ЗавершениеРаботы);
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	Если ЗначениеЗаполнено(Отчет.Организация) И Форма.ИспользуетсяНесколькоОрганизаций Тогда
		ЗаголовокОтчета = ЗаголовокОтчета + " " + РегламентированнаяОтчетностьУСНВызовСервера.ПолучитьТекстОрганизация(

...
Функция ВариантыНастроек() Экспорт 
	...
	Результат.Добавить(Новый Структура("Имя, Представление", "АнализРасходовНаТоварыУСН", НСтр("ru = 'Анализ расходов на товары'")));
	Возврат Результат;
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.АнализРасходовНаТоварыУСН, "АнализРасходовНаТоварыУСН");
	Вариант.Описание = НСтр("ru = 'Отчет показывает движения партий товаров для их отражения в Книге учета доходов и расходов на УСН'");

...
Функция ТекстЗапросаЗаписиРегистраНДСПокупки(СтруктураПараметров)
	...
	|							И НДСЗаписиКнигиПокупок.СчетФактура.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийПриходнаяНакладная.ВозвратОтПокупателя))
	...
	|		ПО НДСЗаписиКнигиПокупок.Организация = ДанныеПервичныхДокументовСчетФактураВыданныйДокументОснование.Организация
	|			И НДСЗаписиКнигиПокупок.СчетФактура = ДанныеПервичныхДокументовСчетФактураВыданныйДокументОснование.Документ
	...
	|		ПО НДСЗаписиКнигиПокупок.Организация = ДанныеПервичныхДокументовСчетФактураПолученныйДокументОснование.Организация
	|			И НДСЗаписиКнигиПокупок.Регистратор = ДанныеПервичныхДокументовСчетФактураПолученныйДокументОснование.Документ
	|ГДЕ

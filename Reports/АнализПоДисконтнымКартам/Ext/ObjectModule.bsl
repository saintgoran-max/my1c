...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["СГруппировкойПоВладельцу"].Теги = НСТР("ru = 'Деньги,Продажи,Бонусы,Лояльность'");
	НастройкиВариантов["СГруппировкойПоНомеруКарты"].Теги = НСТР("ru = 'Деньги,Продажи,Бонусы,Лояльность'");
	НастройкиВариантов["СГруппировкойПоНомеруТелефона"].Теги = НСТР("ru = 'Деньги,Продажи,Бонусы,Лояльность'");
	
КонецПроцедуры

Процедура ДобавитьОписанияСвязанныхПолей(НастройкиВариантов)
	
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["СГруппировкойПоВладельцу"].СвязанныеПоля, "ДисконтнаяКарта", "Справочник.ДисконтныеКарты");
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["СГруппировкойПоНомеруКарты"].СвязанныеПоля, "ДисконтнаяКарта", "Справочник.ДисконтныеКарты");
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["СГруппировкойПоНомеруТелефона"].СвязанныеПоля, "ДисконтнаяКарта", "Справочник.ДисконтныеКарты");

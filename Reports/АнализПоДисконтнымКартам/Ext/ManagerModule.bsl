...
Функция ВариантыНастроек() Экспорт 
	...
	Результат.Добавить(Новый Структура("Имя, Представление", "СГруппировкойПоВладельцу", 
		НСтр("ru = 'Анализ по дисконтным картам.'")));
	Возврат Результат;
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.АнализПоДисконтнымКартам, "СГруппировкойПоВладельцу");

...
Функция ВариантыНастроек() Экспорт 
	...
	Результат.Добавить(Новый Структура("Имя, Представление", "ВедомостьСамозанятые", 
		НСтр("ru = 'Расчеты с самозанятыми'")));
	Результат.Добавить(Новый Структура("Имя, Представление", "ОстаткиСамозанятые", 
		НСтр("ru = 'Остатки расчетов с самозанятыми'")));
	Возврат Результат;
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.РасчетыПоПрочимОперациям, "ВедомостьСамозанятые");
	Вариант.Описание = НСтр("ru = 'В отчете отображаются сведения о расчетах компании с самозанятыми.'");
	Вариант.ФункциональныеОпции.Добавить("ИспользоватьВыплатыСамозанятым");
	Вариант.Размещение.Вставить(Метаданные.Подсистемы.Деньги.Подсистемы.Деньги, "СмТакже");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.РасчетыПоПрочимОперациям, "ОстаткиСамозанятые");
	Вариант.Описание = НСтр("ru = 'В отчете отображаются сведения о расчетах компании с самозанятыми.'");
	Вариант.ФункциональныеОпции.Добавить("ИспользоватьВыплатыСамозанятым");
	Вариант.Размещение.Вставить(Метаданные.Подсистемы.Деньги.Подсистемы.Деньги, "СмТакже");
	Вариант.ВидимостьПоУмолчанию = Ложь;

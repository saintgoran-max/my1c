...
// При заполнении органичения доступа
// Параметры:
...
// 
// Параметры:
//  ДокументСсылкаИзменениеПараметровВА - ДокументСсылка.ИзменениеПараметровВА - Документ для проведения
...
// Таблицы значений сохраняет в свойствах структуры "ДополнительныеСвойства".
//
Процедура СформироватьТаблицаПараметрыВнеоборотныхАктивов(ДокументСсылкаИзменениеПараметровВА, СтруктураДополнительныеСвойства)

...
Функция ПолучитьТекстЗапросаИнициализироватьДанныеДокумента()
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.АктВыполненныхРабот.СведенияПрослеживаемости КАК АктВыполненныхРаботСведенияПрослеживаемости
	...
	ТекстЗапроса = ТекстЗапроса 
		...
		+ РаботаСПодарочнымисертификатами.ТекстЗапросаФормированияВременныхТаблицДляПроведения("ВременнаяТаблицаПредоплата", Ложь, "ВременнаяТаблицаРаботыИУслуги");
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаАктВыполненныхРабот, СтруктураДополнительныеСвойства) Экспорт
	...
	// Прослеживаемость
	ПрослеживаемостьУНФ.СформироватьДвиженияРеализацияТоваров(ДокументСсылкаАктВыполненныхРабот, СтруктураДополнительныеСвойства, "ВременнаяТаблицаРаботыИУслуги");

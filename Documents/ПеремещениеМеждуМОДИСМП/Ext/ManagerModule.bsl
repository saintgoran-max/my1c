...
Процедура ЗаполнитьДанныеУПД_5_02_ИнформацияПродавца(Основание, Настройки, ДеревоДанных, Описание, Отказ) Экспорт
	...
	Иначе
		...
		ПолучитьДанныеЮрФизЛица(ВыборкаШапки.Получатель, СведенияОПокупателе, ВыборкаШапки.ДатаДокумента);
	...
	Если Не ЭтоИндивидуальныйПредприниматель
		...
		ПолучитьДанныеЮрФизЛица(ВыборкаШапки.Отправитель, СведенияОГрузоотправителе, ВыборкаШапки.ДатаДокумента);
...
Процедура ПолучитьДанныеЮрФизЛица(ЮрФизЛицо, Сведения, ДатаСведений) Экспорт
	...
	ЭлектронноеВзаимодействиеИСМППереопределяемый.ЗаполнитьДанныеУчастниковПеремещенияМеждуМОД_5_02(ЗначенияРеквизитовПоЮрФизЛицу, ЮрФизЛицо, ДатаСведений);

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СерииОстаткиДатаПроизводства.Видимость = Номенклатура.ИспользоватьДатуПроизводстваСерии;
	Элементы.СерииОстаткиГоденДо.Видимость = Номенклатура.ИспользоватьСрокГодностиСерии;
	Элементы.СерииОстаткиНаименование.Видимость = Номенклатура.ИспользоватьСрокГодностиСерии Или Номенклатура.ИспользоватьДатуПроизводстваСерии;
	Элементы.СерииОстаткиСерия.Видимость = НЕ Номенклатура.ИспользоватьСрокГодностиСерии И НЕ Номенклатура.ИспользоватьДатуПроизводстваСерии;
	...
	Если ЗначениеЗаполнено(Номенклатура.ПолитикаУчетаСерий) Тогда
		СоздаватьШК = Номенклатура.ПолитикаУчетаСерий.СоздаватьШК;
	КонецЕсли;
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ДекорацияИнформацияПоШтрихкодам", "Видимость", СоздаватьШК);
...
Процедура ВыбратьНомер(Команда)
	...
	Иначе
		ДобавитьСерияВыбранный(Элементы.СерииОстатки.ТекущиеДанные.Серия, Элементы.СерииОстатки.ТекущиеДанные.Количество,
								Элементы.СерииОстатки.ТекущиеДанные.ГоденДо, Элементы.СерииОстатки.ТекущиеДанные.ДатаПроизводства,
...
&НаКлиенте
Процедура ДобавитьСерияВыбранный(Серия, КоличествоВСтроке = 1, ГоденДо = Неопределено, ДатаПроизводства = Неопределено, Наименование = "")

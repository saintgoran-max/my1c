...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОтображаемТолькоАвтСкидки = Ложь;
	Если Параметры.Свойство("ВидДК") И ЗначениеЗаполнено(Параметры.ВидДК) Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(АвтоматическиеСкидки,
			"ВидДК", ВидыДКУсловия, ВидСравненияКомпоновкиДанных.ВСписке);
		ОтображаемТолькоАвтСкидки = Истина;
	ИначеЕсли Параметры.Свойство("ДисконтныеКарты") И Параметры.ДисконтныеКарты Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(АвтоматическиеСкидки,
			"ЕстьУсловияПоДК", Истина);
		ОтображаемТолькоАвтСкидки = Истина;
	КонецЕсли;
	Если ОтображаемТолькоАвтСкидки Тогда
		Элементы.ГруппаРучныеИАвтоматическиеСкидки.ТекущаяСтраница = Элементы.ГруппаАвтоматическиеСкидки;
...
Процедура ГиперссылкаНаВидеоурокНажатие(Элемент)
	...
	АдресСтраницы = "https://rutube.ru/video/ce2469effe44a5d32f9436232f57190f/";

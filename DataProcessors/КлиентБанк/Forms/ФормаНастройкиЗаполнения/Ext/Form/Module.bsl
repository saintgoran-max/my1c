...
Процедура ПодготовитьФормуНаСервере()
	...
	Элементы.ПроводитьПриЗагрузкеПоступлениеНаРасчетныйСчет.Заголовок = НСтр("ru = 'Поступление на счет'");
	Элементы.ПроводитьПриЗагрузкеСписаниеСРасчетногоСчета.Заголовок = НСтр("ru = 'Расход со счета'");

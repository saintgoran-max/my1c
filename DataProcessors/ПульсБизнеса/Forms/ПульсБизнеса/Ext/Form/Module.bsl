...
Процедура Инициализация()
	...
	// АПК:515-вкл
		...
		ДобавитьОписаниеСерииТочки(СтруктураСерий, "Тег", НСтр("ru = 'Тег'"),, ТипДиаграммы.Круговая);
		ДобавитьОписаниеСерииТочки(СтруктураСерий, "ИсточникПривлечения", НСтр("ru = 'Источник привлечения'"),, ТипДиаграммы.Круговая);
		ДобавитьОписаниеСерииТочки(СтруктураСерий, "Ответственный", НСтр("ru = 'Ответственный'"),, ТипДиаграммы.Круговая);
		ДобавитьОписаниеСерииТочки(СтруктураСерий, "ПервичноеПовторное", НСтр("ru = 'Первичное/повторное'"),, ТипДиаграммы.Круговая);
		ДобавитьОписаниеСерииТочки(СтруктураСерий, "Результат", НСтр("ru = 'Результат'"),, ТипДиаграммы.Круговая);
		...
		ДобавитьОписаниеСерииТочки(СтруктураСерий, "ПервичноеПовторное", НСтр("ru = 'Первичное/повторное'"),, ТипДиаграммы.Круговая);
		ДобавитьОписаниеСерииТочки(СтруктураСерий, "Результат", НСтр("ru = 'Результат'"),, ТипДиаграммы.Круговая);
		ДобавитьОписаниеСерииТочки(СтруктураСерий, "Состояние", НСтр("ru = 'Состояние'"),, ТипДиаграммы.Круговая);
		...
		Если ПолучитьФункциональнуюОпцию("ИспользоватьСобытия") Тогда
			...
			СтруктураСерий = Новый Структура;
			ДобавитьОписаниеСерииТочки(СтруктураСерий, "ТипСобытия", НСтр("ru = 'Тип события'"),, ТипДиаграммы.Круговая);
			ДобавитьОписаниеСерииТочки(СтруктураСерий, "Состояние", НСтр("ru = 'Состояние события'"),, ТипДиаграммы.Круговая);
			ДобавитьОписаниеСерииТочки(СтруктураСерий, "Важность", НСтр("ru = 'Важность события'"),, ТипДиаграммы.Круговая);
			ДобавитьОписаниеСерииТочки(СтруктураСерий, "Ответственный", НСтр("ru = 'Ответственный'"),, ТипДиаграммы.Круговая);
		...
		Если ПолучитьФункциональнуюОпцию("ИспользоватьЗадачиСотрудников") Тогда	
			...
			СтруктураСерий = Новый Структура;
			ДобавитьОписаниеСерииТочки(СтруктураСерий, "Ответственный", НСтр("ru = 'Ответственный'"),, ТипДиаграммы.Круговая);
			ДобавитьОписаниеСерииТочки(СтруктураСерий, "Выполнена", НСтр("ru = 'Выполнена'"),, ТипДиаграммы.Круговая);
			ДобавитьОписаниеСерииТочки(СтруктураСерий, "Тег", НСтр("ru = 'Тег'"),, ТипДиаграммы.Круговая);
		...
		СтруктураСерий = Новый Структура;
		ДобавитьОписаниеСерииТочки(СтруктураСерий, "ВидЗаказа", НСтр("ru = 'Вид заказа'"),, ТипДиаграммы.Круговая);
		ДобавитьОписаниеСерииТочки(СтруктураСерий, "ВариантЗавершения", НСтр("ru = 'Вариант завершения'"),, ТипДиаграммы.Круговая);
		ДобавитьОписаниеСерииТочки(СтруктураСерий, "Ответственный", НСтр("ru = 'Ответственный'"),, ТипДиаграммы.Круговая);
		ДобавитьОписаниеСерииТочки(СтруктураСерий, "Организация", НСтр("ru = 'Организация'"),, ТипДиаграммы.Круговая); 

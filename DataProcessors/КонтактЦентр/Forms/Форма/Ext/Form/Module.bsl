...
Процедура Подключаемый_ИзменитьСостояние(Команда)
	...
	ИначеЕсли ВидыКонтактЦентра = 1 Тогда 
		...
		ИмяТекущегоЭлемента = ЭтотОбъект.ТекущийЭлемент.Имя;
...
Процедура ОформитьЭлементПланировщикаВыполненнойЗадачи(ЭлементПланировщика)
	...
	ПоловинаСуммыСоставляющихЦвета 	= 384;
	...
	ОтображатьСветлымТекстом = (ЦветФонаЗеленый + ЦветФонаКрасный + ЦветФонаСиний) < ПоловинаСуммыСоставляющихЦвета;	

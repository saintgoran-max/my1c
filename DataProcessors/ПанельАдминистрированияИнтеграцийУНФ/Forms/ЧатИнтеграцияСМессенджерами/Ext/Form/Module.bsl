...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбновитьИнтерфейсПоФункциональнымОпциям();
...
Процедура ПолучитьФункциональныеОпции()
	...
	ИспользоватьИнтеграцииСистемыВзаимодействия =
	ПолучитьФункциональнуюОпцию("ИспользоватьИнтеграцииСистемыВзаимодействия");
	
КонецПроцедуры

&НаСервере
Процедура ОбновитьИнтерфейсПоФункциональнымОпциям()
	
	Если Не ИспользоватьИнтеграцииСистемыВзаимодействия Тогда
		
		Элементы.ОписаниеРаздела.Заголовок = НСтр("ru = 'Общение пользователей друг с другом в режиме реального времени.'");
		Элементы.ПояснениеПодключениеОбсуждений.Видимость = Ложь;
		Элементы.ОбсужденияНастроитьИнтеграциюСВнешнимиСистемами.Видимость = Ложь;

...
// Возвращаемое значение:
//  Структура:
//		* РаспределятьЗаСчетРучнойСкидки - Булево
//		* ЗапрашиватьРаспределение - Булево
//
Функция ПараметрыИзмененияСуммыДокумента() Экспорт
	
	ПараметрыИзмененияСуммыДокумента = Новый Структура();
	ПараметрыИзмененияСуммыДокумента.Вставить("КорректировкаСуммыЗаСчетРучнойСкидки", Ложь);
	ПараметрыИзмененияСуммыДокумента.Вставить("ЗапрашиватьРаспределение", Ложь);
	
	Возврат ПараметрыИзмененияСуммыДокумента;

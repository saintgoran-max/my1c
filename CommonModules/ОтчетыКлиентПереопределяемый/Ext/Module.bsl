...
Процедура ПослеФормирования(ФормаОтчета, ОтчетСформирован) Экспорт 
	...
	Если ОбщегоНазначенияКлиент.ДоступноИспользованиеРазделенныхДанных() = Ложь Тогда 
		Возврат;
	КонецЕсли;
	
	ОтчетыУНФКлиентСервер.СформироватьКонтактыДляЭкспортаПослеФормированияОтчета(ФормаОтчета); 
	ОтчетыУНФКлиентСервер.СформироватьНоменклатуруДляЭкспортаПослеФормированияОтчета(ФормаОтчета); 
...
Процедура ОбработчикКоманды(ФормаОтчета, Команда, Результат) Экспорт
	...
	//Перенесено в модуль ОтчетыУНФКлиент
	ОтчетыУНФКлиент.ОбработчикКоманды(ФормаОтчета, Команда, Результат);

...
Процедура ПроверитьФормулу(Ошибки, Формула) Экспорт
	...
	МассивПроверяемыхВыражений = ПолучитьМассивПроверяемыхВыражений();	
...
// Возвращает массив выражений, которые не должны быть использованны в формуле.
//
//
Функция ПолучитьМассивПроверяемыхВыражений() Экспорт
	
	Массив = Новый Массив;  	
	Массив.Добавить("ВЫЧИСЛИТЬ");
	Массив.Добавить("ВЫПОЛНИТЬ"); 
	Массив.Добавить("EVAL");
	Массив.Добавить("EXECUTE");
	Массив.Добавить("ЗАФИКСИРОВАТЬТРАНЗАКЦИЮ");

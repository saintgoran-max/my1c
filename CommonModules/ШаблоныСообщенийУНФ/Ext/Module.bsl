...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	ОтключаемыеПредметыПоФО.Вставить(
	Метаданные.Документы.ПриемИПередачаВРемонт.ПолноеИмя(), "ИспользоватьРемонты");
	ОтключаемыеПредметыПоФО.Вставить(
	Метаданные.Документы.ЗаказНаПроизводство.ПолноеИмя(), "ИспользоватьПодсистемуПроизводство");
	ОтключаемыеПредметыПоФО.Вставить(
	Метаданные.Справочники.РабочиеМеста.ПолноеИмя(), "ИспользоватьПодключаемоеОборудование");
	ОтключаемыеПредметыПоФО.Вставить(
	Метаданные.Документы.АктВыполненныхРабот.ПолноеИмя(), "ИспользоватьАктыВыполненныхРабот");
	ОтключаемыеПредметыПоФО.Вставить(
	Метаданные.Документы.ЗаданиеНаРаботу.ПолноеИмя(), "ИспользоватьЗаданияНаРаботу");
...
Процедура ПриЗаполненииПочтыПолучателейВСообщении(ПолучателиПисьма, НазначениеШаблона, ПредметСообщения) Экспорт
	...
	Если Не ЗначениеЗаполнено(Предмет) Или Предмет = "Общий" Тогда
		Возврат;
	КонецЕсли;

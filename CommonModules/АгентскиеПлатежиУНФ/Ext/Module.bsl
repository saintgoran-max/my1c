...
Процедура ЗаполнитьДоговорПлатежногоАгентаВСтроке(СтруктураДанные) Экспорт
	...
	Запрос.УстановитьПараметр("ПризнакиПлатежногоАгента", ПризнакиПлатежногоАгента());
...
// Возвращает массив признаков платежного агента
// 
// Возвращаемое значение:
//  Массив из ПеречислениеСсылка.ПризнакиАгента.
//
Функция ПризнакиПлатежногоАгента() Экспорт
	
	РезультатФункции = Новый Массив;
	
	РезультатФункции.Добавить(Перечисления.ПризнакиАгента.Агент);
	РезультатФункции.Добавить(Перечисления.ПризнакиАгента.БанковскийПлатежныйАгент);
	РезультатФункции.Добавить(Перечисления.ПризнакиАгента.БанковскийПлатежныйСубагент);
	РезультатФункции.Добавить(Перечисления.ПризнакиАгента.ПлатежныйАгент);
	РезультатФункции.Добавить(Перечисления.ПризнакиАгента.ПлатежныйСубагент);
...
Функция ТекстЗапросДанныеАгентскогоДоговора()
	...
	ТекстЗапроса = 
		...
		|	ЕСТЬNULL(ДоговорыКонтрагентов.ПризнакАгента В (&ПризнакиПлатежногоАгента), ЛОЖЬ) КАК ДоговорПлатежногоАгента
		|ИЗ

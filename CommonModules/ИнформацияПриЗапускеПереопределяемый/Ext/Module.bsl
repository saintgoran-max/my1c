...
Процедура ОпределитьНастройки(Настройки) Экспорт
	...
	НачалоРаботыСПрограммойСервер.ОпределитьНастройкиИнформацияПриЗапуске(Настройки);
	ВозможностиПриложения.ОпределитьНастройкиИнформацияПриЗапуске(Настройки);

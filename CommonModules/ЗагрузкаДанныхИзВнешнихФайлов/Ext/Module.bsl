...
Функция ЗагрузитьФайлВТабличныйДокумент(ПараметрыЗагрузки) Экспорт
	...
	Если РасширениеФайла = "csv" Тогда // Платформа не умеет читать файлы csv в табличный документ.
		ЗагрузитьCSVФайлВТабличныйДокумент(ТабличныйДокумент, ИмяВременногоФайла, Разделитель);
	Иначе
...
Процедура ЗагрузитьCSVФайлВТабличныйДокумент(ТабличныйДокумент, ИмяФайла, СимволРазделитель)

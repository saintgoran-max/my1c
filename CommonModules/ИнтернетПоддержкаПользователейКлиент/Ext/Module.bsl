...
//    * Мессенджер - Строка - идентификатор мессенджера, может принмать следующие значения:
//      "Телеграм", "WhatsApp".
//    * Получатель - Строка - контактные данные получателя.
//    * СписокПолучателей - СписокЗначений - список контактных ланных из которых необхоодимо произвести выбор.
//
...
// Инициализует процесс октрытия URL для передачи сообщения пользователю посредством мессенджеров.
//
// Параметры:
...
//    * Мессенджер - Строка - идентификатор мессенджера, может принмать следующие значения:
//      "Телеграм", "WhatsApp".
//    * Получатель - Строка - контактные данные получателя (не учитываются для Телеграма).
//    * СписокПолучателей - СписокЗначений - список контактных данных
//      из которых необхоодимо произвести выбор(не учитываются для Телеграма).
//
...
// Выполянет обработку выбора получателя пользователем,
// продолжает процесс октрытия URL для передачи сообщения пользователю посредством мессенджеров.
//
...
// Выполянет открытие URL для передачи ссылки пользователю посредством Telegram.
//
// Параметры:
//  ТекстСообщения - Строка - текст сообщения для пользователя.
...
//
// Возвращаемое значение:
//  Строка - Ссылка для передачи сообшения пользоваетлю посредством WhatsApp.
//
...
// Выполянет открытие URL для передачи ссылки пользователю посредством WhatsApp.
//
// Параметры:
//  ТекстСообщения - Строка - текст сообщения для пользователя.
//  СсылкаДляПередачи - Строка - URL для пользователя

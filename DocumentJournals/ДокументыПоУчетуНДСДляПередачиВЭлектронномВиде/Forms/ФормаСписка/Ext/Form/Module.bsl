...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПредставлениеНалоговогоПериода = РегламентированнаяОтчетностьУСНКлиентСервер.ПолучитьПредставлениеПериодаОтчета(
		Перечисления.ДоступныеПериодыОтчета.Квартал, НачалоКвартала(ОтборНалоговыйПериод), КонецКвартала(ОтборНалоговыйПериод));
		
	УправлениеНебольшойФирмойКлиентСервер.ИзменитьЭлементОтбораСписка(Список, "НалоговыйПериод", ОтборНалоговыйПериод, ЗначениеЗаполнено(ОтборНалоговыйПериод));
	...
	Если ОтборОрганизация = Справочники.Организации.ПустаяСсылка() Тогда
		...
		УправлениеНебольшойФирмойКлиентСервер.ИзменитьЭлементОтбораСписка(Список, "Организация", ОтборОрганизация, ЗначениеЗаполнено(ОтборОрганизация));
	КонецЕсли; 
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ИзменениеОсновнойОрганизации" Тогда
		ОтборОрганизация = РаботаСОтборами.ИзменитьОтборПоОсновнойОрганизации(Список, ,Параметр);
	КонецЕсли;
...
Процедура ИзменитьПериод(НовыйПериод)
	...
	УправлениеНебольшойФирмойКлиентСервер.ИзменитьЭлементОтбораСписка(Список,
		"НалоговыйПериод",

...
Процедура ДобавитьПолучателейВРассылки()
	...
	Для Каждого Рассылка Из МассовыеРассылки Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(НСтр("ru='ДобавлениеПолучателейВРассылки'",ОбщегоНазначения.КодОсновногоЯзыка()), УровеньЖурналаРегистрации.Ошибка,,, ПодробноеПредставлениеОшибки);
			ТекстСообщения = НСтр("ru='В процессе добавления получателей в рассылки произошла следующая ошибка: %1'");

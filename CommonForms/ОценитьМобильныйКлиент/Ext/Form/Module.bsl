...
Процедура ПриОткрытии(Отказ)
	...
	УстановитьАдресМагазина();
	
КонецПроцедуры  

&НаСервере
Процедура УстановитьАдресМагазина()

	ЭтоРозница = ВозможностиПриложения.ЭтоРозница();
	
	Если МобильныйКлиентУНФКлиентСервер.ЭтоAndroid() Тогда
		Магазин = "Google Play";
		АдресМагазина = МобильныйКлиентУНФКлиентСервер.АдресПубликацииВGooglePlay(Ложь, ЭтоРозница);
	ИначеЕсли МобильныйКлиентУНФКлиентСервер.ЭтоiOS() Тогда
		Магазин = "App Store";
		АдресМагазина = МобильныйКлиентУНФКлиентСервер.АдресПубликацииВAppStore(Ложь, ЭтоРозница);
	КонецЕсли;

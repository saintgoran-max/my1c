...
Процедура ПередЗаписью(Отказ)
	...
	Если ВариантНастройки = "ОбменРТ30"
		ИЛИ ВариантНастройки = "ОбменУНФРТ30" Тогда
		//Поддержка различающихся идентификаторов для настройки через WS.
		Если ОбщегоНазначенияУНФ.ЭтоУНФ() Тогда
			ВариантНастройки = "ОбменРТ30";
		Иначе
			ВариантНастройки = "ОбменУНФРТ30";
		КонецЕсли;
	КонецЕсли;    

	Если ОбщегоНазначенияУНФ.ЭтоУНФ() 
		И ВариантНастройки = "ОбменУНФ_БП3" Тогда

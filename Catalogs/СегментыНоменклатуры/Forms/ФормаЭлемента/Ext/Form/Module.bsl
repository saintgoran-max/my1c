...
Процедура УправлениеФормой()
	...
	Элементы.СвояНоменклатурыПодобратьНоменклатуруВручную.Доступность = РазрешеноРедактированиеСегмента;
	Элементы.КомандыКопированияСтрок.Доступность = РазрешеноРедактированиеСегмента;

...
Функция ОпубликоватьФормуНаСервере()
	...
	ПроксиДляСоединения = ПолучениеФайловИзИнтернета.ПолучитьПрокси("script.google.com");
	Соединение = Новый HTTPСоединение("script.google.com",443,,,ПроксиДляСоединения,,ЗащищенноеСоединение);

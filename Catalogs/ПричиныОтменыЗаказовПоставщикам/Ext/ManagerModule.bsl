...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Если Не НачальноеЗаполнениеЭлементовВыполнено() Тогда
		...
		Элемент.Наименование = НСтр("ru = 'Выбрали другого поставщика'");
		Элемент.ИнициаторОтменыЗаказовПоставщикам = Перечисления.ИнициаторОтменыЗаказовПоставщикам.НашаФирма;
		
		Элемент = Элементы.Добавить();
		Элемент.Наименование = НСтр("ru = 'Задержка поставки'");
...
Функция НачальноеЗаполнениеЭлементовВыполнено()
	...
	|ГДЕ
	|	ПричиныОтменыЗаказовПоставщикам.Предопределенный = ЛОЖЬ";

...
&НаСервере
Функция ПодобратьБанкИзКлассификатора(Ссылки)
	
	Возврат БанкиУНФ.ПодобратьБанкИзКлассификатора(Ссылки);
...
Процедура ОбработатьВыбор(ВыбранныеСтроки, СтандартнаяОбработка)
	...
	Если Ссылки.Количество() > 0 Тогда
		СозданныеБанки = ПодобратьБанкИзКлассификатора(Ссылки);
		Оповестить("ОбновитьПослеДобавления", СозданныеБанки);
	КонецЕсли;

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		// РУНФ
		УправлениеДоступомУНФ.УстановитьОтборВСпискеПрофилиГруппДоступа("", Список);
		// КонецРУНФ
	КонецЕсли;
...
Процедура УстановитьОтбор()
	...
	// РУНФ
	УправлениеДоступомУНФ.УстановитьОтборВСпискеПрофилиГруппДоступа(ПоказатьПрофили, Список);
	// КонецРУНФ

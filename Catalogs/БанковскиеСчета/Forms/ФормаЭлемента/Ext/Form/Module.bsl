...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("БыстроеСоздание") Тогда
		...
		Объект.НомерСчета = ?(СтрДлина(Параметры.НомерСчета) > 20, Лев(Параметры.НомерСчета, 20), Параметры.НомерСчета);
	...
	Если НЕ ПолучитьФункциональнуюОпцию("ИспользоватьПолныеВозможностиБанковскихСчетов") Тогда
		...
		УстановитьПараметрыФункциональныхОпцийФормы(ПараметрыФОСвязанныхОтчетов);
...
Процедура УправлениеЭлементамиФормы()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьПодсистемуДеньги") И Пользователи.РолиДоступны("ЧтениеОстатковДенежныхСредств") Тогда
	...
	Если НЕ ПолучитьФункциональнуюОпцию("ИспользоватьПолныеВозможностиБанковскихСчетов") Тогда
		...
		Элементы.ГруппаВидВалюта.Видимость = Ложь;
		Элементы.НастройкаЭДО.Видимость = Ложь;
		Элементы.ФормаКоманднаяПанель.Видимость = Ложь;
		Элементы.КоманднаяПанельУпрощенно.Видимость = Истина;

...
// Функция возвращает массив пользователей для указанного сотрудника
//
// Параметры:
//  Сотрудник - СправочникСсылка.Сотрудники	 - сотрудник, для которого получаются пользователи
// 
// Возвращаемое значение:
//  Массив - массив типов СправочникСсылка.Пользователи
//

...
Процедура СоздатьКонтрагента(Команда)
	...
	ПараметрыФормы.Вставить(
		...
		Новый Структура(
			...
			"Контрагент", "", Запись.НомерТелефонаАбонента, ПредопределенноеЗначение("Перечисление.ТипыКонтактнойИнформации.Телефон")));
...
Процедура СоздатьЛид(Команда)
	...
	ПараметрыФормы.КонтактКакСвязаться.Вставить("Контакт", "");
	ПараметрыФормы.КонтактКакСвязаться.Вставить("КакСвязаться", Запись.НомерТелефонаАбонента);

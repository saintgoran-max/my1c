...
Процедура ОбновитьКоды_SKU_PLU(ТаблицаТоваров, СоздаватьSKU, ПравилоОбмена = Неопределено, ЗакончилисьSKU = Ложь, УдалятьНеиспользуемыеPLU = Истина) Экспорт
	...
	Если ОбновлятьКодыТоваровPLUНаОборудовании И УдалятьНеиспользуемыеPLU Тогда
...
Процедура УдалитьНеиспользуемыеКодыТоваровPLUНаОборудовании(ТаблицаТоваров, ПравилоОбмена) Экспорт

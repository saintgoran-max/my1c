...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	// Отражение отрицательных остатков по документам ОРП
	РегистрыСведений.СтатусыОтчетовОРозничныхПродажах.ЗапуститьОбновлениеОтраженияОтрицательныхОстатков(Регистратор);

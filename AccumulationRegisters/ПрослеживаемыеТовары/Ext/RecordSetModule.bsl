...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если НЕ ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(СтруктураВременныеТаблицы, "ДвиженияПрослеживаемыеТоварыИзменение", Ложь) Тогда
		...
		|	ПрослеживаемыеТовары.ВидЗапасов КАК ВидЗапасов
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	|		ДвиженияПрослеживаемыеТоварыПередЗаписью.ВидЗапасов КАК ВидЗапасов, 
	...
	|		ДвиженияПрослеживаемыеТоварыПриЗаписи.ВидЗапасов, 
	|		0,
	|		ВЫБОР
	...
	|	ДвиженияПрослеживаемыеТоварыИзменение.ВидЗапасов
	|
	|ИМЕЮЩИЕ
